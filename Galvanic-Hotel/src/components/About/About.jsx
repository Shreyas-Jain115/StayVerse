            ...
            return (
              <div key={idx}>
                <h2 id={`accordion-collapse-heading-${idx}`}>
                  <button
                    type="button"
                    className={`flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-gray-200 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 gap-3 ${idx === 1 ? "rounded-t-xl" : ""} ${idx === accordionItems.length ? "rounded-b-xl" : ""} ${isActive ? "bg-gray-100 dark:bg-gray-800" : ""}`}
