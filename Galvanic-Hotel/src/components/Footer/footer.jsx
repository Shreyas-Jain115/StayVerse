...
const Footer = () => {
  return (
    <footer className="bg-gray-800 text-white p-4 text-center">
      <div className="container mx-auto">
        <p className="text-lg font-semibold">CheckinGo</p>
        <p className="text-sm mt-2">
          Your trusted partner for seamless hotel management and smart check-ins.
        </p>
        <p className="text-sm mt-1">Address: 123 Tech Avenue, SmartCity, Country</p>
        <p className="text-sm">Phone: +1234567890</p>
        <div className="mt-4">
          <a
            href="#"
